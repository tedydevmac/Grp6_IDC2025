...
# Load YOLO11n Model
# ---------------------------
model_path = "/Users/tedgoh/Grp6_IDC2025/ml/models/best7_saved_model_512_60epochs/best_full_integer_quant.tflite"
...
def detect_items(frame, item_classes):
    ...
    """
    results = model.predict(frame, conf=0.6, imgsz=512)  # Lowered confidence threshold for better detection
